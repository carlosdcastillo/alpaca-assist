...
class TestSimpleMcpServerToolRegistry:
    ...
    def test_no_internal_tools_in_registry(self) -> None:
        removed = {
            "echo", "get_time", "read_file", "read_file_range",
            "write_file", "modify_file", "list_files",
            "search_files_for_text", "run_shell_command",
            "evaluate_mypy_python", "evaluate_cargo_check_rust",
        }
